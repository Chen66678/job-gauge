...
export default function ProfilePage() {
  ...
  return <section className="profile-page" aria-label="我的资料">
    ...
    {unconfirmedFacts.length > 0 && <div className="status-bar"><div className="sb-icon">◷</div><div className="sb-text"><div className="sb-count">待确认 <b>{unconfirmedFacts.length}</b> 条事实</div><div className="sb-hint">确认完成后评估更准确——无需全部确认，随时可继续</div></div><button className="btn-batch" onClick={confirmAll}>✓ 全部确认</button></div>}
