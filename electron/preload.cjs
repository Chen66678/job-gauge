...
contextBridge.exposeInMainWorld("coreApi", {
  ...
  setPreferenceRuleSet: (ruleSet) => invokeCoreApi("setPreferenceRuleSet", ruleSet),
  setAutoReevaluateRecentCount: (count) => invokeCoreApi("setAutoReevaluateRecentCount", count),
  getReevaluationPreview: (scope) => invokeCoreApi("getReevaluationPreview", scope),
  reevaluateJobs: (scope) => invokeCoreApi("reevaluateJobs", scope),
